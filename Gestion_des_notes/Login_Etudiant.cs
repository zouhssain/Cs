...
namespace Gestion_des_notes
{
    ...
    public partial class Login_Etudiant : Form
    {
        ...
        private void IsloginValid()
        {
            ...
            string query = "SELECT * FROM `Etudiant` WHERE LOGIN='"+login1+"' AND PASSWORD='"+ password1+"' ";
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())  {
                        ...
                        Espace_Etudiant Espace_Etudiant = new Espace_Etudiant(reader.GetString(5));
                        Espace_Etudiant.Text = reader.GetString(2);
                        Espace_Etudiant.Show();
                        this.Hide();
                    }
                }
                else
        ...
        private void titre_espace_prof_Click(object sender, EventArgs e)
        {
